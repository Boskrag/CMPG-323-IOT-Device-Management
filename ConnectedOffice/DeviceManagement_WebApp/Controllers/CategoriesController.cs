...
;                
        ...
        {
            var categories = await _categoriesRepository.Create(category);
        ...
        public async Task<IActionResult> Edit(Guid id, [Bind("CategoryId,CategoryName,CategoryDescription,DateCreated")] Category category)
        {
            ...
            try
            {
               var categories = await _categoriesRepository.Edit(id);
            }
        ...
        {
            var category = await _categoriesRepository.DeleteConfirmed(id);
